module.exports = Object.assign ( compile, {
  options: [
  '--from', '--service', '--lang', '--for', '--to', '--dest', '--log-level', '--flavor', '--sql-dialect', '--openapi:url'
  ],
  shortcuts: [
...
function compile (models, options={}) {
  ...
  if (options['sql-dialect'])  options.sqlDialect = options['sql-dialect']
  ...
  function consoleLog(o) {
    ...
    if (process.stdout.isTTY)
      o = cds.utils.node_util.inspect(o,{colors: true, depth: 111, compact:false}).replace(/\[Object: null prototype\] /g, '')
    else
