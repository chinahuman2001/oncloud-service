...
exports.buildAuthorizationHeaders = exports.basicHeader = exports.buildAndAddAuthorizationHeader = exports.getAuthHeaders = exports.addAuthorizationHeader = void 0;
...
function hasAuthHeaders(destination) {
    if (!destination.authentication) {
        return false;
    }
    var authTypesWithAuthorizationHeader = [
        'BasicAuthentication',
...
function getAuthHeaders(destination, customHeaders) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            customAuthHeaders = util_1.pickIgnoreCase(customHeaders, 'authorization');
            if (Object.keys(customAuthHeaders).length && hasAuthHeaders(destination)) {
                logger.warn('Found custom authorization headers. The given destination also provides authorization headers. This might be unintended. The custom headers from the request config will be used.');
            }
...
function toAuthorizationHeader(authorization) {
    return util_1.toSanitizedObject('authorization', authorization);
}
function headerFromTokens(authenticationType, authTokens) {
    if (!authTokens || !authTokens.length) {
        throw Error("AuthenticationType is " + authenticationType + ", but no AuthTokens could be fetched from the destination service!");
    }
...
function basicHeader(username, password) {
    return 'Basic ' + util_1.encodeBase64(username + ":" + password);
}
        ...
        return __generator(this, function (_a) {
            ...
            switch (destination.authentication) {
                ...
                case 'OAuth2ClientCredentials':
                    return [2 /*return*/, headerFromTokens(destination.authentication, destination.authTokens)];
...
function buildAuthorizationHeaders(destination) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    sanitizedDestination = destination_1.sanitizeDestination(destination);
                    _a = [{}];
