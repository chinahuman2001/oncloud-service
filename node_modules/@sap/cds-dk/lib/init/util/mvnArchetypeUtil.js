...
class MvnArchetypeUtil {
    ...
    getGenerateCmdArgs(projectName, options, logger = nullLogger) {
        const params = new Map();
        ...
        if (packageFromParam) {
            // explicitely specified, so do not modify
            ...
            if (!packageName.match(REGEX_JAVA_PACKAGE)) {
                ...
                logger.warn(`[cds] The derived package name '${groupId}.${projectName}' is not a valid Java package name. Using '${packageName}' instead.`);
            }
